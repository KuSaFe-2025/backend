...
ASP.NET Core 10 backend для платформы KuSaFe: создание образовательных игр, прохождение заданий, лидерборды, отзывы, статистика, AI-модерация и AI-инструменты автора.
